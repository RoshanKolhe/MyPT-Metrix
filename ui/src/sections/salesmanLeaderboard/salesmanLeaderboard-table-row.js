...
export default function SalesmanLeaderboardTableRow({
  row,
  selected,
  onEditRow,
  onViewRow,
  ...
  const { trainerId, name, department, branch, status, target, actual, achieved, rank } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{trainerId}</TableCell>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{actual}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{achieved}</TableCell>
        <TableCell>
          <Label
            variant="soft"
            color={
...
SalesmanLeaderboardTableRow.propTypes = {
