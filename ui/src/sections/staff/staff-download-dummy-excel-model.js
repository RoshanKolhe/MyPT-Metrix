...
export default function StaffDownloadDummyExcelModel({ open, onClose }) {
  ...
  const onSubmit = handleSubmit(async (formData) => {
    try {
      ...
      const response = await axiosInstance.post('/staff/export-template', payload, {
...
StaffDownloadDummyExcelModel.propTypes = {
