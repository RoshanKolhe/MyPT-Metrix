...
export default function ConductionDownloadDummyExcelModel({ open, onClose }) {
  ...
  const onSubmit = handleSubmit(async (formData) => {
    try {
      ...
      const response = await axiosInstance.post('/conduction/export-template', payload, {
      ...
      link.href = url;
      link.setAttribute('download', 'conductionTemplate.xlsx');
...
ConductionDownloadDummyExcelModel.propTypes = {
