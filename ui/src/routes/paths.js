...
export const paths = {
  ...
  dashboard: {
    ...
    conduction: {
      root: `${ROOTS.DASHBOARD}/conduction`,
      new: `${ROOTS.DASHBOARD}/conduction/new`,
      list: `${ROOTS.DASHBOARD}/conduction/list`,
      edit: (id) => `${ROOTS.DASHBOARD}/conduction/${id}/edit`,
      view: (id) => `${ROOTS.DASHBOARD}/conduction/${id}/view`,
    },
    target: {
      ...
      assignTrainerTarget: (targetId, deptId) =>
        `${ROOTS.DASHBOARD}/target/${targetId}/assign-trainer-target/${deptId}`,
    },
    department: {
    ...
    branch: {
      ...
      view: (id) => `${ROOTS.DASHBOARD}/branch/${id}/view`,
    },
    product: {
