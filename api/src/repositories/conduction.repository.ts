...
export class ConductionRepository extends TimeStampRepositoryMixin<
  ...
  Constructor<
    DefaultCrudRepository<Conduction, typeof Conduction.prototype.id, ConductionRelations>
  >
>(DefaultCrudRepository) {
  ...
  constructor(
    ...
    @repository.getter('TrainerRepository') protected trainerRepositoryGetter: Getter<TrainerRepository>,
    @repository.getter('KpiRepository') protected kpiRepositoryGetter: Getter<KpiRepository>,
    ...
    // Set up BelongsToAccessors and register inclusion resolvers
